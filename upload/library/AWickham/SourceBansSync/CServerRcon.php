...
class AWickham_SourceBansSync_CServerRcon
{
  private $password;
  private $_sock = null;
  private $_id = 0;
  ...
  {
    $PackID = $this->_Write(AWickham_SourceBansSync_CServerRcon::SERVERDATA_AUTH,$this->password);
  ...
  public function sendCommand($command)
  {
    ...
    $this->_Write(AWickham_SourceBansSync_CServerRcon::SERVERDATA_EXECCOMMAND,$command,'');
  }
